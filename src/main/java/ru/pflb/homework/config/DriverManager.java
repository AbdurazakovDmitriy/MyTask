...
public final class DriverManager {
    ...
    public static synchronized WebDriver getWD(String driverType) {
        if (driverType != null && !driverType.equals("") && local.get(driverType)!=null) {
            return local.get(driverType);
        } else {
